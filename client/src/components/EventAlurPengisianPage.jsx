...
function EventAlurPengisianPage({ onBack, onNavigate, onOpenProfile }) {
  ...
  return (
    <div className="relative mx-auto flex min-h-dvh w-full max-w-[390px] flex-col bg-white font-['Inter'] sm:max-w-md">
      ...
      {/* Judul */}
      <h2 className="mt-[40px] text-center text-[16px] font-extrabold tracking-[0.05em] text-black">Alur Pengisian</h2>

      {/* Step Indicator */}
      <div className="mt-[25px] flex items-center justify-center gap-1">
        <span className="text-[10px] font-extrabold tracking-[0.05em] text-black">(1)</span>
        <svg width="29" height="32" viewBox="0 0 29 32" fill="none" className="text-black"><path d="M5 16h19M19 8l8 8-8 8" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"/></svg>
        <span className="text-[10px] font-extrabold tracking-[0.05em] text-black">(2)</span>
        <svg width="29" height="32" viewBox="0 0 29 32" fill="none" className="text-black"><path d="M5 16h19M19 8l8 8-8 8" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"/></svg>
        <span className="text-[10px] font-extrabold tracking-[0.05em] text-black">(3)</span>
      </div>
      ...
      <div className="mt-[76px] flex flex-col gap-[40px] px-[70px]">
        ...
        <div className="flex items-center gap-1">
          ...
          <button type="button" onClick={() => onNavigate?.('pre-event')} className="flex flex-1 items-center justify-between rounded-[10px] bg-[#D5E8FA] px-[41px] py-[15px] shadow-sm transition-all hover:brightness-105 active:scale-[0.98]">
            <span className="text-[24px] font-extrabold tracking-[0.05em] text-black">Pre - Event</span>
        ...
        <div className="flex items-center gap-1">
          ...
          <button type="button" onClick={() => onNavigate?.('dashboard')} className="flex flex-1 items-center justify-between rounded-[10px] bg-[#73B1D8] px-[41px] py-[15px] shadow-sm transition-all hover:brightness-105 active:scale-[0.98]">
