    ...
    <div className="flex h-screen w-full overflow-hidden bg-white font-['Inter']">
      <aside className="flex h-full w-64 shrink-0 flex-col rounded-r-[15px] bg-[#696C74] text-white">
        ...
        <nav className="mt-16 flex flex-col gap-12 px-6">
          ...
          <div className="flex cursor-pointer items-center gap-2" onClick={onBack}><img src={`${IC}/icon-manage.svg`} alt="" className="h-7 w-7 brightness-0 invert" /><span className="text-base font-bold leading-tight text-[#BFE3FF]">Manage<br />User</span></div>
          <div className="flex cursor-pointer items-center gap-2 hover:opacity-80"><img src={`${IC}/icon-settings.svg`} alt="" className="h-6 w-6 brightness-0 invert" /><span className="text-base font-bold">Settings</span></div>
        </nav>
