...
export default function AdminReviewDeniedPage({ onBack, onLogout, onNavigate }) {
    ...
    <div className="flex h-screen w-full overflow-hidden font-['Inter']">
      ...
      <main className="flex flex-1 flex-col bg-[#072D6C]">
        ...
        <div className="flex flex-1 flex-col items-center justify-center gap-3">
          <h2 className="text-[32px] font-bold text-white text-center w-[595px]">
            Perjalanan Dinas Tidak Disetujui
          </h2>
          <p className="text-[24px] font-normal text-white text-center">
            Menunggu Revisi Pegawai
          </p>
        </div>
      </main>
    </div>
